...
#ifndef	FRONTEND_AUTH_CLIENT_HANDLER_H_
#define	FRONTEND_AUTH_CLIENT_HANDLER_H_
...
class AuthClientHandler : public ClientBaseHandler {
public:

  AuthClientHandler() = default;
  ~AuthClientHandler() = default;
...
#endif // FRONTEND_AUTH_CLIENT_HANDLER_H_
