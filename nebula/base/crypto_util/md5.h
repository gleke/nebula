...
#ifndef NEBULA_BASE_MD5_H_
#define NEBULA_BASE_MD5_H_
...
void MD5Update(MD5Context* context, const folly::StringPiece& data);
...
std::string MD5String(const folly::StringPiece& str);

}  // namespace nebula

#endif  // NEBULA_BASE_MD5_H_
