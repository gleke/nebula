...
namespace lua_tinker
{
  ...
  template<>	folly::StringPiece				read(lua_State *L, int index);
	template<>	char				read(lua_State *L, int index);
  ...
  template<>	void push(lua_State *L, folly::StringPiece ret);
  template<>	void push(lua_State *L, const folly::StringPiece& ret);
