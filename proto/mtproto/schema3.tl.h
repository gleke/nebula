...
public:
  ...
  std::string ToString() const override {
    return folly::sformat("{{initConnection#0x69796de9: {{api_id: {}, device_model: {}, system_version: {}, app_version: {}, lang_code: {}, query: {}}}}}",
                          api_id_,
                          device_model_,
                          system_version_,
                          app_version_,
...
public:
  ...
  TLObjectPtr query() { return query_; }
...
private:
  std::vector<std::shared_ptr<TL_message2>> messages_;
};
