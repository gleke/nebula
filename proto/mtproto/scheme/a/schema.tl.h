...
static zproto::ProtoRpcResponsePtr req_pq(zproto::RpcRequestPtr request);
static zproto::ProtoRpcResponsePtr req_DH_params(zproto::RpcRequestPtr request);
static zproto::ProtoRpcResponsePtr set_client_DH_params(zproto::RpcRequestPtr request);
static zproto::ProtoRpcResponsePtr destroy_auth_key(zproto::RpcRequestPtr request);
static zproto::ProtoRpcResponsePtr rpc_drop_answer(zproto::RpcRequestPtr request);
static zproto::ProtoRpcResponsePtr get_future_salts(zproto::RpcRequestPtr request);
static zproto::ProtoRpcResponsePtr ping(zproto::RpcRequestPtr request);
static zproto::ProtoRpcResponsePtr ping_delay_disconnect(zproto::RpcRequestPtr request);
static zproto::ProtoRpcResponsePtr destroy_session(zproto::RpcRequestPtr request);
static zproto::ProtoRpcResponsePtr contest_saveDeveloperInfo(zproto::RpcRequestPtr request);
...
static zproto::ProtoRpcResponsePtr invokeAfterMsg(zproto::RpcRequestPtr request);
static zproto::ProtoRpcResponsePtr invokeAfterMsgs(zproto::RpcRequestPtr request);
static zproto::ProtoRpcResponsePtr initConnection(zproto::RpcRequestPtr request);
static zproto::ProtoRpcResponsePtr invokeWithLayer(zproto::RpcRequestPtr request);
static zproto::ProtoRpcResponsePtr invokeWithoutUpdates(zproto::RpcRequestPtr request);
