...
extern ZOnlineUserDefaultTypeInternal _ZOnlineUser_default_instance_;
class ZUserID;
class ZUserIDDefaultTypeInternal;
extern ZUserIDDefaultTypeInternal _ZUserID_default_instance_;
}  // namespace zproto
namespace zproto {
...
class ZUserID : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:zproto.ZUserID) */ {
 public:
  ...
  #if LANG_CXX11
  ZUserID(ZUserID&& from) noexcept
    : ZUserID() {
    *this = ::std::move(from);
  }

  inline ZUserID& operator=(ZUserID&& from) noexcept {
  ...
  static inline const ZUserID* internal_default_instance() {
    return reinterpret_cast<const ZUserID*>(
  ...
  friend void swap(ZUserID& a, ZUserID& b) {
    a.Swap(&b);
  }

  // implements Message ----------------------------------------------

  inline ZUserID* New() const PROTOBUF_FINAL { return New(NULL); }

  ZUserID* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL;
 ...
 private:
  ...
  friend void ::protobuf_presences_2eproto::InitDefaultsZUserIDImpl();
};
// -------------------------------------------------------------------
...
class ZOnlineUser : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:zproto.ZOnlineUser) */ {
 public:
  ...
  #if LANG_CXX11
  ZOnlineUser(ZOnlineUser&& from) noexcept
    : ZOnlineUser() {
    *this = ::std::move(from);
  }

  inline ZOnlineUser& operator=(ZOnlineUser&& from) noexcept {
    if (GetArenaNoVirtual() == from.GetArenaNoVirtual()) {
      if (this != &from) InternalSwap(&from);
    } else {
      CopyFrom(from);
  ...
  static void InitAsDefaultInstance();  // FOR INTERNAL USE ONLY
  static inline const ZOnlineUser* internal_default_instance() {
    return reinterpret_cast<const ZOnlineUser*>(
  ...
  friend void swap(ZOnlineUser& a, ZOnlineUser& b) {
    a.Swap(&b);
  }

  // implements Message ----------------------------------------------

  inline ZOnlineUser* New() const PROTOBUF_FINAL { return New(NULL); }

  ZOnlineUser* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL;
  int GetCachedSize() const PROTOBUF_FINAL { return _cached_size_; }
  private:
  void SharedCtor();
  void SharedDtor();
 ...
 private:
  ...
  mutable int _cached_size_;
  friend struct ::protobuf_presences_2eproto::TableStruct;
  friend void ::protobuf_presences_2eproto::InitDefaultsZOnlineUserImpl();
};
// -------------------------------------------------------------------
...
#if LANG_CXX11
inline void ZUserID::set_user_id(::std::string&& value) {
  
  user_id_.SetNoArena(
    &::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:zproto.ZUserID.user_id)
}
#endif
...
#if LANG_CXX11
inline void ZOnlineUser::set_user_id(::std::string&& value) {
  
  user_id_.SetNoArena(
    &::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:zproto.ZOnlineUser.user_id)
}
#endif
